...
@section('content')
    <button class="position-fixed bottom-0 end-0 mb-4 me-4 btn btn-danger rounded-circle p-3 lh-1 z-3 increasing-on-resize"
    ...
    <div id="forToast" aria-live="polite" aria-atomic="true" class="position-fixed bottom-0 start-0 mb-4 ms-4 z-2">
